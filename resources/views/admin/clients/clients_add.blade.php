...
<div class="page-container">
    ...
    <div class="main-content">
        <h2 class="text-center mx-auto">ADD NEW CLIENT</h2>
        <div class="container-fluid" style="margin-top:2rem;">

            <div class="paddingnote">
                <form action="{{ url('admin/client_add_insert')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group-row d-flex">
                        <div class="form-group col-md-6 pl-0">
                            ...
                            <input type="number" class="form-control" name="zipcode" placeholder="800 000" required="">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-group-row d-flex">
                        <div class="form-group col-md-6 pl-0">
                            ...
                            <input type="phone" class="form-control" name="telephone" placeholder="phone" required="">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="new-project-name">Alternate Phone Number</label>
                            <input type="phone" class="form-control" name="phone" placeholder="Alt phone" required="">
                        </div>
                    </div>
                    <div class="form-group-row d-flex">
                        <div class="form-group col-md-6 pl-0">
                            <label for="new-project-name">Mobile Phone</label>
                            <input type="number" class="form-control" name="mobile" placeholder="Mobile Phone" required="">
                        </div>
