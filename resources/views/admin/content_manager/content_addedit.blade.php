...
<div class="page-container">
    ...
    <div class="main-content">
        <h2 class="text-center mx-auto">PAGE MANAGER</h2>
        <div class="page-header no-gutters" style="margin-top:3rem;">
            <div class="row mb-30">
                <div class="col-md-9"></div>
                <div class="col-lg-3 text-center">
                    <a href="{{ url('admin/content_addedit_add') }}" class="btn btn-primary">
                        <i class="anticon anticon-plus"></i>
                        <span class="m-l-5">Add New Page</span>
                    </a>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <form action="{{ url('admin/content_addedit_all_delete') }}" method="POST" >
                                    @csrf
                            </div><table class="table mx-auto">
                        <thead>
                            <tr>
                                <th> </th>
                                <th>Page Title</th>
                        ...
                        <tbody>
                            @forelse ($content_addedit as $item)
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-animated scale-left d-flex">
                                        <a class="text-gray font-size-18" href="{{ url('admin/content_addedit_edit',$item->id) }}">
                                            <button class="dropdown-item" type="button">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                        </a>
                                        <a class="text-gray font-size-18" onclick="return confirm('Are you sure?')" href="{{ url('admin/content_addedit_delete', $item->id) }}">
                                            <button class="dropdown-item" type="button">
