...
<div class="page-container">
    ...
    <div class="main-content">
        <h2 class="text-center mx-auto">EDIT PAGE</h2>
        <div class="container-fluid" style="margin-top:3rem;">
            <div class="paddingnote">
                <form action="{{ url('admin/content_addedit_update') }}" method="POST">
                    @csrf
                    <input type="hidden" class="form-control" name="id" value="{{ $content_addedit_edit->id }}">
                    <div class="form-row d-flex">
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="exampleFormControlInput1">Page Name</label>
                            <input type="text" class="form-control" placeholder="enter name" name="page_name"  value="{{$content_addedit_edit->page_name}}">
                            <small> Enter one or two words without spaces that describe this page (example: home, about_us, contacts) Note: This must be unique to this page only, you cannot use the same word for any other page</small>
                        </div>
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="exampleFormControlInput1">Page Title</label>
                            <input type="text" class="form-control" placeholder="Page Title" name="page_title" value="{{$content_addedit_edit->page_title}}">
                    ...
                    <div class="form-row d-flex">
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <textarea class="form-control" rows="3" name="meta_description" >
                                {{$content_addedit_edit->meta_description}}
                            </textarea>
                            <small> Short description of the page. Please enter a short page description. This helps in search engine indexing</small>
                        </div>
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="exampleFormControlTextarea1">SEO Keywords:</label>
                            <textarea class="form-control" rows="3" name="meta_keywords">
                                {{$content_addedit_edit->meta_keywords}}
                            </textarea>
                            <small> Enter a few keywords seperated by a comma for this page. This is also used in search engine optimization for your site. Note: avoid repetitive words or phrases - Max</small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Page Content:</label>
                        <small> Enter your page content here. Use the text formatting icons to make your text more appealing</small>                  
                            ...
                            <div id="mail-compose-editor" class="ql-container ql-snow">
                                ...
                                <div class="ql-tooltip ql-hidden">
                                    <a class="ql-preview" target="_blank" href="about:blank"></a>
                                        <input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL" name="page_content">
                                    <a class="ql-action"></a>
                                    <a class="ql-remove"></a>
                                </div>
                            </div>
