                    ...
                    <div class="page-header no-gutters" style="margin-top:3rem;">
                        <div class="row mb-30">
                            ...
                            <div class="col-lg-3 text-center">
                                <a href="{{ url('admin/content_email_add') }}" class="btn btn-primary">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{ url('admin/content_email_all_delete') }}" method="POST">
                                    @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <div class="dropdown dropdown-animated scale-left d-flex">
                                                    <a href="{{ url('admin/content_email_edit',$item->id) }}" style="font-size:18px;" class="dropdown-item">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a class="dropdown-item" style="font-size:18px;" onclick="return confirm('Are you sure?')" href="{{ url('admin/content_email_delete',$item->id) }}">
