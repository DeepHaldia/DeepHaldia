...
<form action="{{ url('admin/content_email_insert') }}" method="POST">
    @csrf
...
<div id="mail-compose-editor" class="ql-container ql-snow">
    ...
    <div class="ql-tooltip ql-hidden">
        ...
        <input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL" name="email_content">
...
<textarea class="form-control" cols="3" name="email_content2">
