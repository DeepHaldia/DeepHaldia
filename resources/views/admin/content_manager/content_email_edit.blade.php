...
<div class="page-container">
    ...
    <div class="main-content">
        <h2 class="text-center mx-auto">ADD A NEW EMAIL</h2>



        <div class="container-fluid" style="margin-top:3rem;">

            <div class="paddingemail">
               
<form action="{{ url('admin/content_email_update') }}" method="POST">
    @csrf
    <input type="hidden" name="id" value="{{ $content_email_edit->id }}">
<div class="form-row d-flex">
<div class="form-group col-md-6 col-sm-12">
<label for="exampleFormControlInput1">Status</label>
<select name="status" size="1" class="form-control" value="{{ $content_email_edit->status }}">
...
<div class="form-group col-md-6 col-sm-12">
<label for="exampleFormControlInput1">Email Name</label>
<input type="text" class="form-control" name="email_name" value="{{ $content_email_edit->email_name }}">

</div>
</div>

<div class="form-group">
<label for="exampleFormControlTextarea1">Email Subject:</label>
<input type="text" class="form-control" name="email_subject" value="{{ $content_email_edit->email_subject }}">

</div>
<div class="form-group">
<label for="exampleFormControlInput1">Email Content</label>
...
<div id="mail-compose-editor" class="ql-container ql-snow">
    ...
    <div class="ql-tooltip ql-hidden">
        ...
        <input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL" name="email_content" value="{{ $content_email_edit->email_content }}">
...
<div class="form-group">
<label for="exampleFormControlTextarea1" col="7">Email Content:</label>
<textarea class="form-control" cols="3" name="email_content2" value="{{ $content_email_edit->email_content2 }}">

</textarea>
</div>
<div class="form-group mt-3 text-right">
<button class="btn btn-primary">Create Email Page</button>
