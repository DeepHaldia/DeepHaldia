...
<!-- Page Container START -->
  ...
  <form action="{{ url('admin/content_vehicle_insert') }}" method="POST">
    @csrf
    <div class="form-row d-flex">
        ...
        <div class="form-group col-md-6 col-sm-12">
            ...
            <input type="text" class="form-control" name="vehicle_title" value="">
        </div>
        <div class="form-group col-md-6 col-sm-12">
            <label for="exampleFormControlInput1">Passengers</label>
            <input type="number" class="form-control" value="passengers">
        </div>
    </div>
        ...
        <label for="exampleFormControlTextarea1">Vehicle Description:</label>
            ...
            <div id="mail-compose-editor" class="ql-container ql-snow">
                ...
                <div class="ql-tooltip ql-hidden">
                    ...
                    <input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL" name="vehicle_description">
    ...
    <div class="form-group">
        <label for="exampleFormControlInput1">Vehicle Name</label>
        <input type="file" id="myFile" name="vehicle_image" >

    </div>
    <div class="form-group text-right">
        <button class="btn btn-primary">Create Vehicle Page</button>
