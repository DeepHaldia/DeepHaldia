...
<div class="page-container">
    ...
    <div class="main-content">
        <h2 class="text-center mx-auto">ADD A New Locaiton</h2>
        <div class="container-fluid" style="margin-top:2rem;">
            <div class="container w-50">
                <div class="modal-body">
                    <form action="{{url('admin/price_location_insert') }}" method="post">
                        @csrf
                        <div class="form-group row">
                        <div class="form-group col-md-12 col-sm-12">
                            <label for="new-project-name">Zone ID</label>
                            <select name="zone_id" size="1" class="form-control" name="zone_id" require="">
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <select name="location_type" size="1" class="form-control" name="location_type">
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <input name="name" class="form-control col-md-6" size="39" type="text" required="">
                        </div>
                        </div>
                        <div class="form-group row">
                        <div class="form-group col-md-12 col-sm-12">
                            <label for="new-project-name">Address</label>
                            <input name="address" class="form-control" size="39" type="text" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="new-project-name">City</label>
                            <input name="country" class="form-control" size="39" type="text" required="">
                        </div>
                        <div class="form-group col-md-6 col-sm-12">
                    ...
                    <div class="form-group row">
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input name="zip_code" class="form-control" size="39" type="text">
                        </div>
                        <div class="form-group col-md-6  col-sm-12">
                            <label for="new-project-name">Phone Number</label>
                            <input name="phone_number" class="form-control" size="39" type="text">
                        </div>
                    </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary text-center">Add Location</button>
                        </div>
                    </form>
                </div>
            </div>            
