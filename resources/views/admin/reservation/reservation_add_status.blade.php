...
<!-- Page Container START -->
            <div class="page-container">
                ...
                <div id="menu-toggle" class="main-content">
                    <h2 class="text-center mx-auto">ADD A NEW STATUS</h2>                   
             
                <div class="container-fluid" style="margin-top:3rem;">

                    <div class="paddingnote">
                        <form class="text-center" method="post" action="{{ url('admin/reservation_status_insert') }}">
                            @csrf
                        <div class="form-group">
                            <label for="new-project-name">Status Name</label>
                            <input type="text" class="form-control col-md-6 mx-auto" name="status_name" placeholder="name" required="">
                        </div>
                        <div class="form-group">
                            <label for="new-project-name">Status Description</label>
                            <textarea class="form-control col-md-6 mx-auto" name="message" required="">
