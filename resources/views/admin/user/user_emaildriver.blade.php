...
<!-- Side Nav END -->
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <h2 class="text-center mx-auto">EMAIL MANAGER</h2>
                    <div class="page-header no-gutters" style="margin-top:3rem;">
                        <div class="row mb-30">
                            <div class="col-md-9"></div>
                            <div class="col-lg-3 text-center">
                                <a href="{{ url('admin/user_emaildriver_add') }}" class="btn btn-primary">
                                    <i class="anticon anticon-plus"></i>
                                    <span class="m-l-5">Add New Email</span>
                                </a>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{ url('admin/user_emaildriver_all_driver') }}" method="POST">
                                    @csrf
                                <table class="table mx-auto">
                                    ...
                                    <tbody>
                                        @forelse ($user_emaildriver as $item)
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <div class="dropdown dropdown-animated scale-left d-flex">
                                                    <a href="{{ url('admin/user_emaildriver_edit',$item->id) }}" style="font-size:18px;" class="dropdown-item">
                                                        <i class="fas fa-edit"></i>
                                                    </a>

                                                    <a class="dropdown-item" style="font-size:18px;" onclick="return confirm('Are you sure?')" href="{{ url('admin/user_emaildriver_delete',$item->id) }}">
