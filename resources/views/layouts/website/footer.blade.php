<footer class=footer-wrapper>
    <div class="footer-container container">
        <div class="footer-column three columns" id=footer-widget-1>
            <div id=text-5 class="widget widget_text limoking-item limoking-widget">
                ...
                <div class=textwidget>
                    <p>At Sunstate, we are committed to exceed your expectations.</p>
                    <p><img src="{{ asset('assets/upload/logo.png')}}" style="width: 170px;" alt></p>
                </div>
            </div>
        </div>
        <div class="footer-column three columns" id=footer-widget-2>
            <div id=text-9 class="widget widget_text limoking-item limoking-widget">
                ...
                <div class=clear></div>
                <div class=textwidget>
                    Address: 7021 Grand National Park Dr Suite 104, Orlando FL 32819
                    <span class=clear></span><span class=limoking-space
                        style="margin-top: 10px; display: block;"></span>
                    <i class="limoking-icon fa fa-phone"
                    ...
                    <i class="limoking-icon fa fa-mobile"
                        style="vertical-align: middle; color: #fff; font-size: 20px; "></i>
                    Fax: 407-601-7901<span class=clear></span><span class=limoking-space
                        style="margin-top: 10px; display: block;"></span>
                    <i class="limoking-icon fa fa-envelope-o"
                        style="vertical-align: middle; color: #fff; font-size: 16px; "></i>
                    reservations@sunstatelimo.com
        ...
        <div class="footer-column three columns" id=footer-widget-4>
            <div id=gdlr-recent-portfolio2-widget-6
                class="widget widget_gdlr-recent-portfolio2-widget limoking-item limoking-widget">
                ...
                <div class=limoking-recent-port2-widget>
                    <div class=recent-port-widget-thumbnail>
                        <a href=#><img src="{{ asset('assets/upload/shutterstock_770756561-150x150.jpg') }}" alt width=150
                                height=150></a>
                    </div>
                    <div class=recent-port-widget-thumbnail>
                        <a href=#><img src="{{ asset('assets/upload/shutterstock_1058269641-150x150.jpg')}}" alt width=150
                                height=150></a>
                    </div>
                    <div class=recent-port-widget-thumbnail>
                        <a href=#><img src="{{ asset('assets/upload/shutterstock_1837970511-150x150.jpg')}}" alt width=150
                                height=150></a>
                    </div>
                    <div class=recent-port-widget-thumbnail>
                        <a href=#><img src="{{ asset('assets/upload/shutterstock_716302901-150x150.jpg')}}" alt width=150
                                height=150></a>
                    </div>
                    <div class=recent-port-widget-thumbnail>
                        <a href=#><img src="{{ asset('assets/upload/shutterstock_2580348261-150x150.jpg') }}" alt width=150
                                height=150></a>
                    </div>
                    <div class=recent-port-widget-thumbnail>
                        <a href=#><img src="{{ asset('assets/upload/shutterstock_1427849831-150x150.jpg')}}" alt width=150
                                height=150></a>
                    </div>
                    <div class=clear></div>
                </div>
    ...
    <div class=copyright-wrapper>
        <div class="copyright-container container">
            <div class=copyright-left> Sunstate Transportation - Copyright © 2021, All Right Reserved</div>
            <div class=copyright-right> <a href="http://facebook.com/goodlayers"><i
                        class="limoking-icon fa fa-facebook"
                        style="vertical-align: middle;color: #bbbbbb;font-size: 20px"></i></a> <a
                        href="http://twitter.com/goodlayers"><i class="limoking-icon fa fa-twitter"
                        style="vertical-align: middle;color: #bbbbbb;font-size: 20px"></i></a> <a href=#><i
                        class="limoking-icon fa fa-dribbble"
                        style="vertical-align: middle;color: #bbbbbb;font-size: 20px"></i></a> <a href=#><i
                        class="limoking-icon fa fa-pinterest"
                        style="vertical-align: middle;color: #bbbbbb;font-size: 20px"></i></a> <a href=#><i
                        class="limoking-icon fa fa-google-plus"
                        style="vertical-align: middle;color: #bbbbbb;font-size: 20px"></i></a> <a href=#><i
...
<script src="{{ asset('assets/js/jquery/jquery-migrate.min.js') }}"></script>
<script src="{{ asset('assets/plugins/superfish/js/superfish.js') }}"></script>
<script src="{{ asset('assets/js/hoverIntent.min.js') }}"></script>
<script src="{{ asset('assets/plugins/dl-menu/modernizr.custom.js') }}"></script>
<script src="{{ asset('assets/plugins/dl-menu/jquery.dlmenu.js') }}"></script>
...
<script src="{{ asset('assets/plugins/fancybox/helpers/jquery.fancybox-media.js') }}"></script>
<script src="{{ asset('assets/plugins/fancybox/helpers/jquery.fancybox-thumbs.js') }}"></script>
<script src="{{ asset('assets/plugins/flexslider/jquery.flexslider.js') }}"></script>
<script src="{{ asset('assets/plugins/jquery.isotope.min.js') }}"></script>
<script src="{{ asset('assets/js/plugins.js') }}"></script>
<script src="{{ asset('assets/js/isotope.js') }}"></script>
<script src="{{ asset('assets/plugins/jquery.transit.min.js') }}"></script>
<script src="{{ asset('assets/plugins/gdlr-car/gdlr-car-script.js') }}"></script>
<script src="{{ asset('assets/plugins/masterslider/public/assets/js/masterslider.min.js') }}"></script>
