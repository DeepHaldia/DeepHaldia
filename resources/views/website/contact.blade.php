...
@section('content')
        ...
        <div class=content-wrapper>
            <div class=limoking-content>
                ...
                <div class="with-sidebar-wrapper mt-5 pt-3">
                    <div class="with-sidebar-container container">
                        <div class="with-sidebar-left eight columns">
                            <div class="with-sidebar-content twelve columns">
                                <section id=content-section-2>
                                    <div class="section-container container">
                                        <div class="limoking-item limoking-content-item" style="margin-bottom: 60px;">
                                            <span class=clear></span><span class=limoking-space style="margin-top: -22px; display: block;"></span>
                                                    ...
                                                    <form class="quform" action="plugins/quform/process.php" method="post" enctype="multipart/form-data" onclick="">
                                                        ...
                                                        <div class="quform-elements">
                                                            ...
                                                            <div class="quform-submit">
                                                                <div class="quform-submit-inner col-md-12 col-sm-12 pl-0">
                            ...
                            <div class="limoking-item-start-content sidebar-right-item">
                                ...
                                <div id=text-7 class="widget widget_text limoking-item limoking-widget">
                                    ...
                                    <div class=textwidget>
                                        <p>Address: 7021 Grand National Park Dr Suite 104, Orlando FL 32819</p>
                                        <p><i class="limoking-icon fa fa-phone" style="vertical-align: middle; color: #444444; font-size: 16px; "></i> 407-601-7900</p>
                                        <p><i class="limoking-icon fa fa-envelope" style="vertical-align: middle; color: #444444; font-size: 16px; "></i> reservations@sunstatelimo.com</p>
                ...
                <div class=below-sidebar-wrapper>
                    <section id=content-section-3>
                        <div class="limoking-parallax-wrapper limoking-background-image gdlr-show-all no-skin" id=limoking-parallax-wrapper-1 data-bgspeed=0.2 style="background-image: url('{{asset('assets/upload/modern-bg1.jpg') }}'); padding-top: 100px; padding-bottom: 50px; ">
                                ...
                                <div class="four columns">
                                    <div class="limoking-box-with-icon-ux limoking-ux">
                                        <div class="limoking-item limoking-box-with-icon-item pos-top type-circle">
                                            <div class="box-with-circle-icon">
